...
//this basechass is abstract base class because it is made to point to derived class and its function is
//pure virtual function which is never executed but the function with same name is need to be made in 
//derived class

//abstract base class is a class containing at least one pure virtual function
class CWH{
    protected:
        char title[30];
        float ratings;
    public:
        ...
        //this function is pure virtual function which is never executed but function with same name is 
        //made in derived class and is compulsory to do it      
        //   =0 makes a virtual function , pure virtual function
